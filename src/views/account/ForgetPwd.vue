        ...
        <el-tabs v-model="retrieveType" class="login-form">
          <el-tab-pane label="邮箱找回" name="email">
            <el-form ref="emailForm" :model="retrieveAccountForm" :rules="emailRules" label-width="0px" status-icon>
              ...
              <el-form-item>
                <el-button class="width-full" type="primary" @click="sendEmailValidateHandle"> 找回密码 </el-button>
              </el-form-item>
            </el-form>
          </el-tab-pane>
        </el-tabs>
      ...
      <div class="reset-pwd-inner-wrap">
        ...
        <el-form ref="resetPwdForm" :model="resetPwdForm" :rules="pwdRules" label-width="0px">
          <el-form-item label="" prop="password">
            <el-input v-model="resetPwdForm.password" autocomplete="off" placeholder="请输入密码" show-password />
          </el-form-item>
          <el-form-item label="" prop="rePassword">
            <el-input v-model="resetPwdForm.rePassword" autocomplete="off" placeholder="请再次输入密码" show-password />
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="resetPasswordHandle"> 提交 </el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
