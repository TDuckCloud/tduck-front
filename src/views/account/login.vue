...
<!--                            <el-row>-->
<!--                                <el-col :span="6">-->
<!--                                    <el-link class="login-tip" @click="toForgetPwdHandle">-->
<!--                                        忘记密码-->
<!--                                    </el-link>-->
<!--                                </el-col>-->
<!--                                <el-col :span="6">-->
...
<!--                                </el-row>-->
<!--                                &lt;!&ndash;                                <el-row>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                    <el-col :offset="8">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                        <div class="other-login">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                            <span @click="redirectUrl(qqLoginAuthorizeUrl)">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                                <svg-icon class="other-login-icon" name="loginQQ" />&ndash;&gt;-->
<!--                                &lt;!&ndash;                                            </span>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                            <svg-icon class="other-login-icon"&ndash;&gt;-->
<!--                                &lt;!&ndash;                                                      name="loginWx"&ndash;&gt;-->
<!--                                &lt;!&ndash;                                                      @click="()=>{&ndash;&gt;-->
<!--                                &lt;!&ndash;                                                          this.formType='login'&ndash;&gt;-->
<!--                                &lt;!&ndash;                                                          this.loginType='wx'&ndash;&gt;-->
<!--                                &lt;!&ndash;                                                      }"&ndash;&gt;-->
<!--                                &lt;!&ndash;                                            />&ndash;&gt;-->
<!--                                &lt;!&ndash;                                        </div>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                    </el-col>&ndash;&gt;-->
