...
<!--                            {{ template.name }}-->
<!--                        </p>-->
<!--                        &lt;!&ndash;                        <p style="color: rgba(189, 188, 188, 100); font-size: 12px; margin: 0;">&ndash;&gt;-->
<!--                        &lt;!&ndash;                            {{ template.likeCount }}人喜欢&ndash;&gt;-->
<!--                        &lt;!&ndash;                            <svg-icon name="like" style="width: 12px; height: 12px;" />&ndash;&gt;-->
<!--                        &lt;!&ndash;                        </p>&ndash;&gt;-->
