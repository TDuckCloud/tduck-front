import { deleteFormRequest, stopFormRequest } from '@/api/project/form'
import { logicDeleteFormRequest } from '../../../api/project/form'
...
export default {
    ...
    methods: {
        ...
        toProjectHandle(form, type) {
            this.$store.dispatch('form/setBackRoute', this.$route.path)
            this.$router.push({
